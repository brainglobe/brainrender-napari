...
def test_signal_connections(manager_widget, qtbot, mocker):
    ...
    manager_widget.atlas_manager_view.progress_updated.connect(mock_update_progress)
    manager_widget.atlas_manager_view.download_atlas_confirmed.connect(mock_operation_completed)
    manager_widget.atlas_manager_view.update_atlas_confirmed.connect(mock_operation_completed)
    ...
    manager_widget.atlas_manager_view.download_atlas_confirmed.emit("test_atlas")
